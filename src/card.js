...
function Projects() {
  const cardInfo = [
      ...
      {image: "/Users/BelmontOST/React-Portfolio/public/images/Readmesample.png", title: "ReadMe", text: "As a new developer, I created a command-line application that dynamically generates a professional README.md file from a user's input using the [Inquirer package].The application will be invoked by using a command line interface.", link: "https://drive.google.com/drive/u/0/folders/1v0rulICqsLHiWyfzDpIceyfsumWM58vE", link: "https://github.com/Nishyo-coder/Readme-App"},
