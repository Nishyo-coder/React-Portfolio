...
function MoreDeets() {
  const cardInfo = [
      ...
      {image: "/images/Covid Safety Image.png", title: "Safer In the Know", text: "My team created a centralized application to gather important pandemic, health-related details and country-related news in order to deliver them to people in a user-friendly manner.", link: "", link: ""},
      {image: "/images/Readmesample.png", title: "ReadMe", text: "As a new developer, I created a command-line application that dynamically generates a professional README.md file from a user's input using the [Inquirer package].The application will be invoked by using a command line interface.", link: "", link: ""},
      {image: "/images/Scheduler.png", title: "Scheduler", text: "", link: "https://nishyo-coder.github.io/Daily-Planner/", link: "https://github.com/Nishyo-coder/Daily-Planner"},
  ];
